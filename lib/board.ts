...
export const seedRows: CurationRow[] = [
  ["niulang-zhinu", "牛郎织女", "欣颖", "", 0, 0, 0, 0, 0],
  ["menora", "Menora（泰国）", "民强 & 守恒", "", 0, 0, 0, 0, 0],
  ["hunli", "婚礼", "珈玮 & 惠翎", "", 0, 0, 0, 0, 0],
  ["baishezhuan", "白蛇传", "慧翎", "", 0, 0, 0, 0, 0],
  ["mulan", "花木兰", "凯钲", "", 0, 0, 0, 0, 0],
  ["change", "嫦娥奔月", "可薇", "", 0, 0, 0, 0, 0],
  ["liang-shanbo", "梁山伯与祝英台", "竣铭", "", 0, 0, 0, 0, 0],
  ["mengjiangnu", "孟姜女", "采萤", "", 0, 0, 0, 0, 0],
  ["nezha", "哪吒", "民强", "", 0, 0, 0, 0, 0],
  ["guanyu", "关公", "素岑", "", 0, 0, 0, 0, 0],
  ["mazu", "妈祖", "健美", "", 0, 0, 0, 0, 0],
  ["baosheng", "保生大帝", "喻萱", "", 0, 0, 0, 0, 0],
  ["qixi", "七夕", "惠翎", "", 0, 0, 0, 0, 0],
  ["yuanxiao", "元宵", "凯钲", "", 0, 0, 0, 0, 0],
  ["shadow-puppet", "皮影戏", "可薇", "", 0, 0, 0, 0, 0],
  ["lion-dance", "舞狮", "竣铭", "", 0, 0, 0, 0, 0],
  ["clan-stories", "姓氏故事", "采萤", "", 0, 0, 0, 0, 0]
